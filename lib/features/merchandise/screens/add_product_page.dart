    ...
    try {
      ...
      if (mounted) {
        ...
        if (response['success'] == true) {
          ...
          _showErrorDialog(response['error'] ?? 'Failed to create product');
        }
      }
    } catch (e) {
      if (mounted) {
        ...
        return AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              const Text(
                "You've Successfully Add New Merchandise!",
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Launch new merchandise for your event',
