                      ...
                      onChanged: (value) {
                        if (_usernameError != null) {
                          ...
                          _formKey.currentState!
                              .validate(); // Hapus merah saat ketik
                        }
                      },
                      validator: (value) {
                            ...
                            if (context.mounted) {
                              ...
                              setState(() {
                                ...
                                if (message.toLowerCase().contains(
                                  ...
                                  _usernameError =
                                      " "; // Spasi kosong agar border merah tapi teks tidak double
                                  _passwordError =
                                      message; // Pesan lengkap ditaruh di bawah password
                                }
