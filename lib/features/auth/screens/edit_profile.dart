...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  // PERBAIKAN 1: Samakan URL dengan profile_screen.dart
  static const String profileUrl =
      'http://127.0.0.1:8000/event-organizer/profile/json/'; 
  static const String updateUrl =
      'http://127.0.0.1:8000/event-organizer/edit-profile-flutter/';
  ...
  Future<void> _fetch() async {
    ...
    try {
      final resp = await request.get(profileUrl);
  ...
  Future<void> _save() async {
    ...
    try {
      final resp = await request.post(updateUrl, {
