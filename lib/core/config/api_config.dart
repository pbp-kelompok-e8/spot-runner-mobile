...
class ApiConfig {
  ...
  static String reviewsByEvent(String eventId) =>
      '$baseUrl/review/api/reviews/?event_id=$eventId';
  static String eventReviews(String eventId) =>
      '$baseUrl/review/api/reviews/event/$eventId/';
  static String editReview(String reviewId) =>
      '$baseUrl/review/$reviewId/edit/';
  ...
  static String get redeemMerchandise =>
      '$baseUrl/merchandise/redemption/json/';
  ...
  static String merchandiseDetail(String id) =>
      '$baseUrl/merchandise/json/$id/';
  static String editMerchandiseUrl(String id) =>
      '$baseUrl/merchandise/edit-flutter/$id/';
  static String deleteMerchandiseUrl(String id) =>
      '$baseUrl/merchandise/delete-flutter/$id/';
  static String redeemMerchandiseUrl(String id) =>
      '$baseUrl/merchandise/$id/redeem/';
  static String proxyImage(String encodedUrl) =>
      '$baseUrl/merchandise/proxy-image/?url=$encodedUrl';
  ...
  static String deleteEventUrl(String id) =>
      '$baseUrl/event/delete-flutter/$id/';
  ...
  static String eventOrganizerProfile() =>
      '$baseUrl/event-organizer/profile/json/';
  static String eventOrganizerJson() => '$baseUrl/event-organizer/json/';
  static String deleteAccountUrl() =>
      '$baseUrl/event-organizer/delete-account-flutter/';
  ...
  static String participateUrl(
    String username,
    String eventId,
    String category,
  ) => '$baseUrl/api/participate/$username/$eventId/$category/';
}