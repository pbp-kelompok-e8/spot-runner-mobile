...
List<EventDetail> eventDetailFromJson(String str) => List<EventDetail>.from(json.decode(str).map((x) => EventDetail.fromJson(x)));

String eventDetailToJson(List<EventDetail> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
